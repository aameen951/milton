...
// void DrawBezierCurve(int n, v2f* curve)
// {
...
// int main()
// {
//     static v2f d[7] = {	/*  Digitized points */
// 	{ 0.0, 0.0 },
// 	{ 0.0, 0.5 },
// 	{ 1.1, 1.4 },
// 	{ 2.1, 1.6 },
...
//     v2f	*d;			/*  Array of digitized points	*/
...
//     double	error;		/*  User-defined error squared	   */
// {
//     v2f*	bezCurve; /*Control points of fitted Bezier curve*/
...
// 		bezCurve = (v2f *)malloc(4 * sizeof(v2f));
// 		bezCurve[0] = d[first];
// 		bezCurve[3] = d[last];
...
//  *
//  */
// static v2f*  GenerateBezier(d, first, last, uPrime, tHat1, tHat2)
//     v2f	*d;			/*  Array of digitized points	*/
...
//     v2f*	bezCurve;	/* RETURN bezier curve ctl pts	*/
// 	double  segLength;
// 	double  epsilon;
...
//     v2f*	bezCurve;	/*  Current fitted curve	*/
// {
...
//     v2f*	Q;			/*  Current fitted curve	*/
//     v2f 		P;		/*  Digitized point		*/
//     double 		u;		/*  Parameter value for "P"	*/
// {
//     double 		numerator, denominator;
//     v2f 		Q1[3], Q2[2];	/*  Q' and Q''			*/
//     v2f		Q_u, Q1_u, Q2_u; /*u evaluated at Q, Q', & Q''	*/
...
//  * 
//  */
// static v2f BezierII(degree, V, t)
//     int		degree;		/* The degree of the bezier curve	*/
//     v2f 	*V;		/* Array of control points		*/
//     double 	t;		/* Parametric value to find point for	*/
// {
//     int 	i, j;		
//     v2f 	Q;	        /* Point on curve at parameter t	*/
//     v2f 	*Vtemp;		/* Local copy of control points		*/

//     /* Copy array	*/
//     Vtemp = (v2f *)malloc((unsigned)((degree+1) 
// 				* sizeof (v2f)));
//     for (i = 0; i <= degree; i++) {
// 		Vtemp[i] = V[i];
//     }
...
//     v2f	*d;			/*  Array of digitized points	*/
//     int		first, last;		/*  Indices defining region	*/
//     v2f*	bezCurve;		/*  Fitted Bezier curve		*/
